...
> **On our [Agentforce practice](https://future.emergedigital.com/?utm_source=vision&utm_medium=engagement-map), the same three phases are packaged as Discovery → Pilot → Enterprise.** Crawl maps to Discovery, Walk to Pilot, Run to Enterprise. The names differ to fit how AI delivery is bought; the risk-managed sequencing is identical.
